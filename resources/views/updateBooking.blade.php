...
<body>
    ...
    <div class="container">
        <div class="calendar">
            ...
            <div>
                <p><strong>Geselecteerde datum:</strong> <span id="displayedDate">{{ $bookingDay }}
                        {{ $bookingMonth }} {{ $bookingYear }}</span></p>
                ...
                <div class="form-content">
                    <div class="container-19">
                        ...
                        <div class="container-13">
                            <input type="first_name" name="first_name" class="rectangle-12" placeholder="Voornaam"
                                readonly value="{{ $booking->first_name }}">
                            <input type="last_name" name="last_name" class="rectangle-17" placeholder="Achternaam"
                                readonly value="{{ $booking->last_name }}">
                        </div>
                        <div class="emailadres">E-mailadres</div>
                        <input type="email" name="email" class="rectangle-13" placeholder="E-mailadres" readonly
                            value="{{ $booking->email }}">
                        ...
                        <div class="container-20">
                            ...
                            <input type="tel" id="phone" name="phone" class="rectangle-14"
                                placeholder="Telefoonnummer" readonly value="{{ $booking->phone }}">
                        </div>
                    </div>
            ...
            function renderTimeSlots() {
                ...
                dayTimes.slice(0, slotsToShow).forEach(({
                    ...
                    if (status === 1) {
                        ...
                        'disabled'); // Add custom class for highlighted slots when status is 1 and disable it
                    } else {
